                        ...
                        <Layout>
                            <div className="">
                                <section className={styles.helloSection}>
                                    <div className={styles.aboutWanders}>
                                        ...
                                        <div className={styles.descriptionWanders}>
                                            ...
                                            <p>Авторские туры — отлично организованные приключения по уникальным
                                                маршрутам в
                                                дружеской компании. Приглашаем авторов зарегистрироваться на Wanders,
                                                разместить
                                    ...
                                    <div className={`${styles.row} ${styles.bookingRow}`}>
                                        <div className={styles.col_4}>
                                            <div className={`${styles.box1} ${styles.booking}`}>
                                                <h3>Выбери тур</h3>
                                                <p>Переходи в раздел туры. Выбери понравившийся тур. Ознакомься с
                                                    программой и
                                                    датой
                                                    тура</p>
                                            </div>
                                        ...
                                        <div className={styles.col_4}>
                                            <div className={`${styles.box2} ${styles.booking}`}>
                                                <h3>Оставь заявку</h3>
                                                <p>Понравился тур? Оставь заявку на сайте и организатор сам с тобой
                                                    свяжется</p>
                                            </div>
                                        </div>
                                        <div className={styles.col_4}>
                                ...
                                <section className={styles.ourTourCollection}>
                                    ...
                                    <Link to={'/tours'} className={styles.homePageBtn}>
                                ...
                                <section className={styles.ourTourCollection}>
                                    ...
                                    <Link to={'/locations'} className={styles.homePageBtn}>
                                        <button>Смотреть еще</button>
                                    </Link>
                                </section>
                                <section className={styles.ourTourCollection}>
